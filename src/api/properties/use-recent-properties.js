...
const mimicGetRecentlyAddedProperties = async () => {
  const data = [
    {
      id: "image1",
      price: "12,000",
...
export function useRecentlyAddedProperties(config) {
  const queryKey = getQueryKey('recent');
  return useQuery(queryKey, mimicGetRecentlyAddedProperties, config);
}
